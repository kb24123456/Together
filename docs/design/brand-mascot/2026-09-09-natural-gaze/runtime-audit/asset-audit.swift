...
do {
    ...
    check("33 named timelines exported", artboard.animationNames().count == 33, details: artboard.animationNames().count)
    ...
    let cases: [(String, Float, Bool, [String])] = [
        ("idle", 0, false, ["Idle", "Idle_QuietShort", "Idle_QuietMedium", "Idle_Look", "Idle_GazeUp", "Idle_GazeDown", "Idle_GazeUpRight"]),
    ...
    check("acknowledge returns to an idle animation", ["Idle", "Idle_QuietShort", "Idle_QuietMedium", "Idle_Look", "Idle_GazeUp", "Idle_GazeDown", "Idle_GazeUpRight"].contains(winkStates.last ?? ""))
