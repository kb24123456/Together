...
def pose(idx):
    ...
    if idx==2:left=right=arc(w=62);lx,rx=-59,59
    elif idx==3:left=stroke([(-24,-19),(11,0),(-24,19)],16);right=stroke([(24,-19),(-11,0),(24,19)],16);lx,rx=-60,60;mouth=bowl(65,50);mo=100
    ...
    elif idx in [16,26,28]:left=right=capsule(17,63);lx,rx=-62,62;lr=rr=90;ly=ry=-30
    elif idx==17:left=right=bowl(58,21);lx,rx=-62,62;mouth=ellipse(16,20);mo=100;ly=ry=-34
    elif idx==18:left=right=arc(False,55,19,15);lx,rx=-60,60
